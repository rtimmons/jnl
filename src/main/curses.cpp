// https://gist.githubusercontent.com/daleobrien/7535489/raw/0312993c141f0a1644d7821f676c102c30c9af3f/ncurses_stl.cpp

/*
clang++ -std=c++1z $(PKG_CONFIG_PATH=/usr/local/opt/ncurses/lib/pkgconfig pkg-config --cflags --libs ncurses) ./curses.cpp
*/
