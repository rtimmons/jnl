...
from typing import Generator, TextIO, Pattern, AnyStr, Dict, List

from colorama import init, Fore, Style

from jnl.all import Database, EntryMatch
from jnl.system import Opener
...
class Searcher(object):
    def __init__(self, database: Database, opener: Opener):
    ...
    def _search(self, pattern: Pattern[AnyStr], scr: TextIO) -> None:
        entries: Dict[str, List[EntryMatch]] = self.database.entries_matching(
            pattern
        )
        index: int = 0
        ...
        self.opener.open(entries[key_of_choice][0].entry)